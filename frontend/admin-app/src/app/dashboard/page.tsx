...
import { Shield, Users, UtensilsCrossed, BarChart3, LogOut, BookOpen } from 'lucide-react';
    ...
    <div className="flex h-screen bg-gray-100">
      <aside className="w-64 bg-white shadow-sm flex flex-col">
        ...
        <div className="p-4 border-t space-y-2">
          <Link href="/about" className="flex items-center gap-2 text-sm text-gray-500 hover:text-indigo-600 w-full px-4 py-2">
